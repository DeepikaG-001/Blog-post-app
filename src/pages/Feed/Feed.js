...
*/
  ...
  finishEditHandler = (postData) => {
    ...
    if (this.state.editPost) {
      formData.append(
        "oldPath",
        this.state.editPost.imagePath.replace(/\\/, "/")
      );
    }
    ...
    fetch("http://localhost:8080/post-image", {
      ...
      .then((resData) => {
        ...
        const post = {
          ...
          imagePath: resData.data[resDataField].imageUrl.replace(/\\/g, "/"),
        };
        this.setState((prevState) => {
        ...
        //       p._id === prevState.editPost._id
        //         ? { ...p, creator: resData.post.creator }
        //         : p
        //     );
